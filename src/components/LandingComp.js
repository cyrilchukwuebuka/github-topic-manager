import {
  Box, Button, Container, Flex, Image, Link, Text,
    ...
    <Container maxW="container.xl" w="100%" h="calc(100vh - 80px)" padding="10px">
      ...
      >
        ...
        <Flex align="center" justify="center" direction="column" p={4}>
          ...
          <Text fontSize={{ base: '14px', md: '16px', lg: '18px' }} textAlign="center">
            Click on
            <Link as={ReactLink} to="/how-it-works" _hover={{ color: 'brand.300', textDecoration: 'none' }} _focus={{ outline: 'none' }} fontStyle="italic" fontSize={{ base: '16px', md: '18px', lg: '20px' }} fontWeight="500">How It Works</Link>
            {' '}
