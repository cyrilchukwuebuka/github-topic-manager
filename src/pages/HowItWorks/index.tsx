...
const HowItWorks: FC<{}> = () => {
    ...
    return (
        <Flex direction={isLargerThan653 ? 'row' : 'column'} maxW='container.xl' w='100%' h='calc(100vh - 80px)' padding={5}>
            ...
            <Flex px='3%' w={isLargerThan653 ? '50%' : '100%'} h={isLargerThan653 ? '100%' : '50%'} direction='column'>
                <Text h='7%' mb='5%' textDecoration='underline' fontSize={{ base: '18px', md: '23px', lg: '28px' }} textAlign='center' fontWeight='600'>How It Works</Text>
                <Flex mt={isLargerThan653 ? '' : '2.5%'} h={isLargerThan653 ? 'fit-content' : '200px'} direction='column' align='center' overflowY='scroll' scrollBehavior='smooth' sx={{
                    ...
                    <Flex w='100%' px='5%' py={3} align='center' justify='flex-start'>
                        <Flex w='5%'>
                            <Box h={{ base: '4px', md: '6px', lg: '8px' }} w={{ base: '4px', md: '6px', lg: '8px' }} bgColor={bgColor} borderRadius='50%'></Box>
                        </Flex>
                        <Flex w='95%'>
                            <Text textAlign='justify' fontStyle='italic' fontSize={{ base: '12px', md: '18px', lg: '16px' }}>To be able to make use of this application, you first need to log in with a github account credentials</Text>
                        </Flex>
                    </Flex>
                    <Flex w='100%' mb='10px' px='5%' py={3} align='center' justify='flex-start'>
                        <Flex w='5%'>
                            <Box h={{ base: '4px', md: '6px', lg: '8px' }} w={{ base: '4px', md: '6px', lg: '8px' }} bgColor={bgColor} borderRadius='50%'></Box>
                        </Flex>
                        <Flex w='95%'>
                    ...
                    <Flex w='100%' mb='10px' px='5%' py={3} align='center' justify='flex-start'>
                        ...
                        <Flex w='95%'>
                            <Text textAlign='justify' fontStyle='italic' fontSize={{ base: '12px', md: '18px', lg: '16px' }}>When done with the selection, click on the "Add Topic" button to pop up a Modal</Text>
                        </Flex>
                    </Flex>
                    <Flex w='100%' mb='10px' px='5%' py={3} align='center' justify='flex-start'>
                        <Flex w='5%'>
                        ...
                        <Flex w='95%'>
                            <Text textAlign='justify' fontStyle='italic' fontSize={{ base: '12px', md: '18px', lg: '16px' }}>Type in the topic(s), comma seperated</Text>
                        </Flex>
                    </Flex>
                    <Flex w='100%' mb='10px' px='5%' py={3} align='center' justify='flex-start'>
                        <Flex w='5%'>
                    ...
                    <Flex w='100%' mb='10px' px='5%' py={3} align='center' justify='flex-start'>
                        ...
                        <Flex w='95%'>
                            <Text textAlign='justify' fontStyle='italic' fontSize={{ base: '12px', md: '18px', lg: '16px' }}>Having successfully made change(s) to repo(s) topic, user can proceed to check out each repo for change(s) made to it</Text>
                        </Flex>
                    </Flex>
                    <Flex w='100%' mb='10px' px='5%' py={3} align='center' justify='flex-start'>
                        <Flex w='5%'>
