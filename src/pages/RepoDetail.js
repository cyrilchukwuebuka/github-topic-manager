import {
  Box, Button, Container, Flex, Image, Link, Modal, ModalBody, ModalCloseButton, ModalContent, ModalOverlay, Spinner, Text, useColorModeValue, useDisclosure, useMediaQuery,
...
import {
  fetchAsyncRepo, getLoader, getRepo, removeFetchedRepo,
...
const RepoDetail = () => {
  ...
  const {
    name, description, topics, html_url,
  } = repo;
